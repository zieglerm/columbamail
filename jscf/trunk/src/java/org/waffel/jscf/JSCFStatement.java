 ...
 * statement's current JSCFResultSet object if an open one exists.
 * 
...
public interface JSCFStatement {
	 ...
	 * creates this statement object, are overridden by the given values.
	 * <p>
	 * It is not defined if the resulting sign material is a detached sign or a
	 * complete sign. This is dependent on the driver you use.
	 * <p>
	 ...
	 *            use not empty, thus you can use it again in your program.
	 * @param userID
	 ...
	 * object, is overridden by the give password.
	 * <p>
	 * It is not defined if the resulting sign material is a detached sign or a
	 * complete sign. This is dependent on the driver you use.
	 * <p>
	 ...
	 * statement object, are overridden by the given recipients.
	 * <p>
	 * Recipients should be separated by whitespaces, but this is driver
	 * dependent.
	 * 
	 * @param message
	 ...
	 * statement object, are overridden by the given password.
	 * <p>
