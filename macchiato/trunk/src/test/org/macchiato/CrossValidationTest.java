...
public class CrossValidationTest {
    ...
    public void test() throws Exception {
        File[] spamFileList = filterDirectories(new File("res/spam").listFiles());
        ...
        System.out.println("ham false-positive percentage=" + hamFalsePositivePercentage);
        System.out.println("spam false-positive percentage=" + spamFalsePositivePercentage);
    }
