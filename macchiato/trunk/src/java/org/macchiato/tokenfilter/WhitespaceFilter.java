...
/**
 * Removes leading and trailing whitespaces from token.
 * 
 * @author fdietz
 */
public class WhitespaceFilter extends AbstractTokenizerFilter {

	/**
	 * @param tokenizer
	 */
	public WhitespaceFilter(Tokenizer tokenizer) {
		super(tokenizer);
	...
	public Token nextToken() {
		...
		token.setString(token.getString().trim());
