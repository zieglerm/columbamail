...
/**
 * Filter everything which doesn't consist of [A-Za-z]. 
 *
 * @author fdietz
 */
public class WordFilter extends AbstractTokenizerFilter {
	 ...
	 * @param tokenizer
	 */
	public WordFilter(Tokenizer tokenizer) {
		super(tokenizer);
	...
	public Token nextToken() {
		...
		if (!p1.matcher(token.getString()).matches())
			return Token.SKIP;
