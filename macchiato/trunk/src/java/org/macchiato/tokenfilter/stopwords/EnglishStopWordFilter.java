 ...
 * @author fdietz
 */
public class EnglishStopWordFilter extends AbstractStopWordFilter {
	private EnglishStopWordProvider instance;

	/**
	 * Default constructor
	 */
	public EnglishStopWordFilter(Tokenizer tokenizer) {
		super(tokenizer);
	}
	...
	public StopWordProvider getStopWordProviderInstance() {
		if (instance == null) {
			instance= new EnglishStopWordProvider();
		}
