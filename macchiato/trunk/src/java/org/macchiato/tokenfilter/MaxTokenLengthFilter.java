...
/**
 * Filter tokens which have more than specified characters.
 *
 * @author fdietz
 */
public class MaxTokenLengthFilter extends AbstractTokenizerFilter {
	 ...
	 * @param tokenizer
	 */
	public MaxTokenLengthFilter(Tokenizer tokenizer, int length) {
		super(tokenizer);
	...
	public Token nextToken() {
		...
		// check if string length > specified length
