...
public class MessageParser {
	...
	/**
	 * Parses a RFC 2822 or 2045 compliant message. Basically this is done
	 * by calling the HeaderParser and the BodyParser.
	 * 
	 * @see HeaderParser
	 * @see BodyParser
	 * 
	 * @param message the Source of the message.
