 ...
 * It consistis of a human readable display name and the technical mail address.
 *
...
public class Address implements Serializable, Comparable {
     ...
     * <p>
     * <b>Note:</b> If you want to parse an Address from a String use the <code>static</code> {@link #parse(CharSequence)} instead. 
     *
     * @param mailAddress a valid mail address (e.g. my@mail.org).
     */
     ...
     * <b>Note:</b> If you want to parse an Address from a String use the <code>static</code> {@link #parse(CharSequence)} instead. 
     *
     * @param displayName the name to display for this address, i.e. the real name (e.g. Timo Stich).
     * @param mailAddress A valid mail address (e.g. my@mail.org).
     */
    ...
    /**
     * Gets the displayname. The returned String can be used to give a human readable representation of the mail address.
     * <p>
     * Example: "Timo Stich"
     *
     * @return the human readable String representation or <code>null</code> if not set.
     */
    ...
    /**
     * Gets the mail address. This is the technical part of the mail address as defined
     * in RFC 2822. 
     * <p>
     * Example: my@mail.org
     *
    ...
    /**
     * Get the canonical form of the mailaddress. This is basically the technical mail address
     * in brackets and is defined in RFC 2822.
     * <p>
     * Example: &lt;my@mail.org&gt;
     *
    ...
    /**
     * Gets the short form of the address. This is either the human readable display name if available
     * or the technical mail address.
     * <p>
     ...
     * Example: "Timo Stich"
     *
     * @param displayName the human readable representation of the address.
     */
    ...
    public String toString() {
        if (displayName == null || displayName.length() == 0) {
            ...
            return "\"" + displayName + "\" " + getCanonicalMailAddress();
        }
    }
     ...
     * 
     * @param source the address that is parsed, e.g. "Timo Stich &lt;my@mail.org&gt;"
