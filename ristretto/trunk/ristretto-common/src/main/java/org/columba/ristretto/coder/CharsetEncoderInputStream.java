...
public class CharsetEncoderInputStream extends FilterInputStream {
	 ...
	 * 
	 * @param arg0 the characterstream
	 * @param charset the charset the characterstream is encoded in
	 */
	...
	private int encodeNextCharacter() throws IOException {
		...
		outBytes.clear();
		CoderResult result = encoder.encode( inBytes, outBytes, in.available() == 0 );
