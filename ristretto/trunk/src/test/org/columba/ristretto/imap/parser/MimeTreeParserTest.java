...
public class MimeTreeParserTest extends TestCase {
	
	public void testNested() throws ParserException {
		String input = "* 1468 FETCH (UID 3159 BODYSTRUCTURE ((\"TEXT\" \"PLAIN\" (\"CHARSET\" \"US-ASCII\") NIL NIL \"7BIT\" 503 9 NIL NIL NIL)(\"MESSAGE\" \"DELIVERY-STATUS\" NIL NIL NIL \"7BIT\" 186 NIL NIL NIL)(\"MESSAGE\" \"RFC822\" NIL NIL NIL \"7BIT\" 2690 (\"Sun, 13 Jun 2004 23:10:42 +0200\" \"Re[2]: [Columba-users] Columba RC1-test3 released\" ((\"Peter Karp\" NIL \"peter\" \"karpfenteich.net\")) ((NIL NIL \"columba-users-admin\" \"lists.sourceforge.net\")) ((\"Peter Karp\" NIL \"peter\" \"karpfenteich.net\")) ((\"Frederik Dietz\" NIL \"columba\" \"frederikdietz.de\")(NIL NIL \"columba-users\" \"lists.sourceforge.net\")) NIL NIL \"<dvfgqdpr.yvv1yprb24w8@frd.playboy.wg>\" \"<PM-EY.20040613231042.97DA0.3.1D@mail.karpfenteich.net>\") (\"TEXT\" \"PLAIN\" (\"CHARSET\" \"US-ASCII\") NIL NIL \"7BIT\" 37 1 NIL NIL NIL) 51 NIL NIL NIL) \"REPORT\" (\"REPORT-TYPE\" \"delivery-status\" \"BOUNDARY\" \"1087220410-439-HOME.SE\") NIL NIL))\r\n";
