 ...
 * END LICENSE BLOCK
 */
package org.columba.ristretto.examples.simplesmtp;
...
/**
 * SimpleSMTP class - This is a simple command line smtp client. It shows the usage of the Ristretto SMTP capabilities.
 * 
 * @author timo
 */
    ...
    try {
      ...
      if (user != null) {
        ...
        if (authCapability != null) {
          try {
            protocol.auth(AuthenticationFactory.getInstance().getSecurestMethod(authCapability), user, password
                .toCharArray());
