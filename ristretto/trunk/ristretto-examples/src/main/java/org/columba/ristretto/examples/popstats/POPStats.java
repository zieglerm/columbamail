 ...
 * END LICENSE BLOCK
 */
package org.columba.ristretto.examples.popstats;
...
import org.columba.ristretto.examples.messagedecomposer.MessageDecomposer;
...
/**
 * POPStats class - A command line utility to read the status of a POP3 Server. Can also be useful in debugging why a
 * POP server might appear not to be working properly.
 * 
 * @author timo
 */
