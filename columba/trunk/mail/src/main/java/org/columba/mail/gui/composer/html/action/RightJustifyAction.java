...
/**
 * Right justify selected paragraph "align="right" in
 * <p>
 * -tag
 *
 * @author fdietz, Karl Peder Olesen (karlpeder)
 */
public class RightJustifyAction extends AbstractComposerAction {
	...
	public RightJustifyAction(IFrameMediator frameMediator) {
		...
		putValue(SHORT_DESCRIPTION, MailResourceLoader.getString("menu",
				"composer", "menu_format_right_justify_tooltip").replaceAll(
				"&", ""));

		putValue(LARGE_ICON, MailImageLoader
				.getIcon("format-justify-right.png"));
		putValue(SMALL_ICON, MailImageLoader
				.getSmallIcon("format-justify-right.png"));

	}

	public void formatChanged(FormatChangedEvent event) {
		setState(event.getInfo().isAlignRight());
	}
	...
	public void actionPerformed(ActionEvent evt) {
		...
		editorController.setRightJustify();
	}
}
