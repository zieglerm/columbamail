 ...
 * @author fdietz
 */
public class ItalicFormatAction extends AbstractComposerAction {
	...
	public void formatChanged(FormatChangedEvent event) {
		setState(event.getInfo().isItalic());
	}
