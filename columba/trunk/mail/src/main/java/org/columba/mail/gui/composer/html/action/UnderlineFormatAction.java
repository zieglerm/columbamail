 ...
 * @author fdietz
 */
public class UnderlineFormatAction extends AbstractComposerAction {
	 ...
	 * @param name
	 */
	public UnderlineFormatAction(IFrameMediator frameMediator) {
		super(frameMediator, MailResourceLoader.getString("menu", "composer",
				"menu_format_underline"));

		putValue(SHORT_DESCRIPTION, MailResourceLoader.getString("menu",
				"composer", "menu_format_underline_tooltip")
				.replaceAll("&", ""));

		putValue(LARGE_ICON, MailImageLoader
				.getIcon("format-text-underline.png"));
		putValue(SMALL_ICON, MailImageLoader
				.getSmallIcon("format-text-underline.png"));
	...
	public void formatChanged(FormatChangedEvent event) {
		setState(event.getInfo().isUnderline());
	}
