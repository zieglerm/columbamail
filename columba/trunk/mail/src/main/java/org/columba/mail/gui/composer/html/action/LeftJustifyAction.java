...
/**
 * Left justify selected paragraph "align="left" in
 * <p>
 * -tag
 *
 * @author fdietz, Karl Peder Olesen (karlpeder)
 */
public class LeftJustifyAction extends AbstractComposerAction {
	 ...
	 * @param name
	 */
	public LeftJustifyAction(IFrameMediator frameMediator) {
		super(frameMediator, MailResourceLoader.getString("menu", "composer",
				"menu_format_left_justify"));

		putValue(SHORT_DESCRIPTION, MailResourceLoader.getString("menu",
				"composer", "menu_format_left_justify_tooltip").replaceAll("&",
				""));

		putValue(LARGE_ICON, MailImageLoader.getIcon("format-justify-left.png"));
		putValue(SMALL_ICON, MailImageLoader
				.getSmallIcon("format-justify-left.png"));

	}

	public void formatChanged(FormatChangedEvent event) {
		setState(event.getInfo().isAlignLeft());
	}
	...
	public void actionPerformed(ActionEvent evt) {
		...
		editorController.setLeftJustify();
	}
}
