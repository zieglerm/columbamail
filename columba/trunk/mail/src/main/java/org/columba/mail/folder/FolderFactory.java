...
public class FolderFactory {
	...
	public IMailFolder createVirtualFolder(IMailFolder parent, String name) throws FolderCreationException {
		IMailFolder child;
		try {
			IExtension extension = handler.getExtension("VirtualFolder");

			child = (IMailFolder) extension.instanciateExtension(new Object[] {name});
