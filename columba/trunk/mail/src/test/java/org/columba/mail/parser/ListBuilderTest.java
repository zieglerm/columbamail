...
public class ListBuilderTest {
    ...
    private static IContactItem contact1;
    private static IContactItem contact2;
    private static IGroupItem group1;
    private static IGroupItem group2;
    ...
    public void testCreateFlatListWithNamesOnly() {
        ...
        Assert.assertEquals("name1@mail.org", result.get(0));
        Assert.assertEquals("name2@mail.org", result.get(1));
    ...
    public void testCreateFlatListWithGroups2() {
        ...
        Assert.assertEquals("name1@mail.org", result.get(0));
        Assert.assertEquals("name2@mail.org", result.get(1));
        Assert.assertEquals("name2@mail.org", result.get(2));
    }
    ...
    public void testCreateStringListFromItemList() {
        ...
        Assert.assertEquals("name1", result.get(0));
        Assert.assertEquals("name2", result.get(1));
    }
