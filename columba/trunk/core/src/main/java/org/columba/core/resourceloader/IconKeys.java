...
public interface IconKeys {
	...
	public static final String CANCEL = "process-stop.png";
	...
	public static final String EXIT = "system-log-out.png";

	public static final String EDIT_FIND = "edit-find.png";

	public static final String PREFERENCES = "preferences-system.png";

	public static final String INTERNET = "internet-web-browser.png";

	public static final String USER = "system-users.png";

	public static final String IMAGE_MISSING = "image-missing.png";

	public static final String DIALOG_INFO = "dialog-information.png";
	...
	public static final String SEARCH = "system-search.png";
